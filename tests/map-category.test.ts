...
describe('mapCategory', () => {
  ...
  it('should map between taxonomies if possible', () => {
    const inputs: [string, CategoryTaxonomy, CategoryTaxonomy, string[]][] = [
      ...
      ['190', CategoryTaxonomies.AD_PRODUCT_V1, CategoryTaxonomies.AD_PRODUCT_V2, []], // Consumer Electronics
      ['109', CategoryTaxonomies.AD_PRODUCT_V1, CategoryTaxonomies.AD_PRODUCT_V2, []], // Automotive services
      ['648', CategoryTaxonomies.AD_PRODUCT_V1, CategoryTaxonomies.AD_PRODUCT_V2, []], // Food & Beverage services
      ...
      ['demographic_age_18_24', CategoryTaxonomies.AUDIENCE_V1_1, CategoryTaxonomies.AD_PRODUCT_V2, []], // something else ends up being null

      // Unmappable categories (should return null)
      ['IAB25', CategoryTaxonomies.CONTENT_V1, CategoryTaxonomies.CONTENT_V2, []], // Non-Standard Content (deprecated)
      ['IAB26', CategoryTaxonomies.CONTENT_V1, CategoryTaxonomies.CONTENT_V2, []], // Illegal Content (deprecated)
      ['invalid_category', CategoryTaxonomies.CONTENT_V1, CategoryTaxonomies.CONTENT_V2, []], // Invalid category
      ['IAB999', CategoryTaxonomies.CONTENT_V1, CategoryTaxonomies.CONTENT_V2, []], // Non-existent category
